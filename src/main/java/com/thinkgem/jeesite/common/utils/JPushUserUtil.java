...
public class JPushUserUtil {
	private final static String appKey = "2b7eb6df7bf791d91373b12c";
	 
    private final static String masterSecret = "a76dc52c6879edf940392281";
    
    public static Log LOG = LogFactory.getLog(JPushUserUtil.class);
 ...
 */
 ...
 public static void sentMessageAll(String alert,String title,String id,String type,String alias){
	  ...
	  PushPayload payload = buildPushObjectAlertAll(alert,title,"{\"id\":\""+id+"\",\"type\":\""+type+"\"}",alias);
	  try {
	        PushResult result = jPushClient.sendPush(payload);
	        LOG.info("Got result - " + result);
