...
public class User extends DataEntity<User> {
	...
	public String getAreaIdList() {
		...
		return  StringUtils.join(AreaIdList.toArray(), ",");
	}

	public void setAreaIdList(List<String> roleIdList) {
		areaList = Lists.newArrayList();
		for (String areaId : roleIdList) {
			Area area = new Area();
			area.setId(areaId);
			areaList.add(area);
		}
	...
	public String getAreaNameList() {
		...
		return StringUtils.join(AreaNameList.toArray(), ",");
	}
