...
//		}
	...
	public String delete(Area area, RedirectAttributes redirectAttributes) {
		...
		Map<String, Object> map = areaService.selectAreaRelation(area);
		if (null!=map) {
			
		if(null!=map.get("user")||null!=map.get("driver")||null!=map.get("vehicle")||null!=map.get("orders")){
			addMessage(redirectAttributes, "有关联该地区（或下级地区）的用户，车辆，司机，订单，不允许删除！");
			return "redirect:" + adminPath + "/sys/area";
		}
		}
//		if (Area.isRoot(id)){
