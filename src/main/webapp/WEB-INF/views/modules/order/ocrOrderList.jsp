...
<body>
	...
	<form:form id="searchForm" modelAttribute="ocrOrderVO" action="${ctx}/order/ocrOrder/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li><label>状态：</label>
				<form:select path="status" placeholder="请选择订单状态" class="input-medium">
					...
					<form:options items="${fns:getDictList('order_status_for_platform')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</li>
			<li><label>出发时间：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			...
			<tr>
				...
				<td>
					${fns:getDictLabel(ocrOrder.status, 'order_status_for_platform', '')}
				</td>
