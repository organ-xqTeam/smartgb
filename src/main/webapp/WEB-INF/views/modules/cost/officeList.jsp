	...
	<script type="text/javascript">
		...
		function page(n,s){
			...
			//if (str_text.value=="请输入单位名称"){
  			//	str_text.value="";
 			//}
			$("#searchForm").attr("action","${ctx}/cost/ocrCost/officeList");
			$("#searchForm").submit();
	    	return false;
	    }
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cost/ocrCost/officeList">单位列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="office" action="${ctx}/cost/ocrCost/officeList" method="post" class="breadcrumb form-search ">
...
<th>已收</th>
	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<!--<td>{{row.useable}}</td>-->
			<td>
				<a href="${ctx}/cost/ocrCost/list?companyId={{row.id}}&companyName={{row.name}}">查看</a>
