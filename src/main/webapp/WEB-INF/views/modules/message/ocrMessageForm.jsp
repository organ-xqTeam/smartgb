...
<body>
	...
	<form:form id="inputForm" modelAttribute="ocrMessage" action="${ctx}/message/ocrMessage/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="content" htmlEscape="false" rows="15" maxlength="2000" class="required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<%-- <div class="control-group">
			...
			<div class="controls">
				<form:select path="receiveSide" class="required">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('receive_side')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div> --%>
