...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group" >
            ...
            <div class="controls">
                <sys:treeselect id="areaIdList" name="areaIdList" value="${user.areaIdList}" labelName="area.name" labelValue="${user.areaNameList}"
                    title="区域" url="/sys/area/treeDataForDirverAndVehicle" cssClass="required" checked="true"/>
                <span class="help-inline"><font color="red">*</font> </span>
            </div>
        </div>
		<div class="control-group">
