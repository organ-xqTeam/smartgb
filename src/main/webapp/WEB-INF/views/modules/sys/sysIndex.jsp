...
<head>
	...
	<style type="text/css">
		body{padding:0}
		#main {padding:0;margin:0;background-color:#f4f8fb;}
		#main .container-fluid{padding:0;}
		#header {position:static;} 
		#header li {font-size:18px; color:#7698FB; _font-size:12px;}
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:24px;background-color:#f04f57;width:270px;text-align:center;line-height: 66px;padding: 0;}
		#footer {margin:8px 0 0 0;padding:3px 0 0 0;font-size:11px;text-align:center;}
		#footer, #footer a {color:#999;} 
		#left{overflow-x:hidden;overflow-y:auto;background-color: #17283c;} 
		#left .collapse{position:static;}
		#userControl{margin-right:1.8%;}
		#userControl>li>a{color:#7698FB;font-size:12px;text-shadow:none;line-height: 66px;padding: 0 10px;} 
		#userControl>li>a:hover, #user #userControl>li.open>a{background:transparent;}
		#top_navbar{height:66px;border: none;background-color:#fff;background-image:none;}
		.navbar .nav>.active>a, .navbar .nav>.active>a:hover, .navbar .nav>.active>a:focus{background-color:#fff;}
		.navbar .nav>li>a:focus, .navbar .nav>li>a:hover{background-color:#fff;box-shadow: inset 0 3px 8px rgba(0,0,0,0.125)}
		#menu li a{height:66px;line-height: 66px;padding: 0 20px;color: #696969;text-shadow:none;}
    	.accordion-group{border:none;}
    	.accordion-heading{background-color:rgba(255,255,255,0.05);background-image: none;border-radius: 4px;padding: 4px 0;}
    	.accordion-heading a:hover, .dropdown a:hover{color:#fff;}
    	.accordion-toggle{text-align: center;font-size: 16px !important;color:#fff;padding:0;}
    	.accordion-inner{border:none;}
    	.accordion-inner .nav-list li a{padding:10px 0;text-align:center;}
    	.nav>li>a:hover, .nav>li>a:focus{background-color:rgba(255,255,255,0);}
    	.nav-list>li>a, .nav-list .nav-header{text-shadow:none;color:#fff;margin:0;}
    	.nav-list>.active>a, .nav-list>.active>a:hover, .nav-list>.active>a:focus{text-shadow:none;background-color:rgba(255,255,255,0);}
...
<body>
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div id="top_navbar" class="navbar-inner">
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;">
