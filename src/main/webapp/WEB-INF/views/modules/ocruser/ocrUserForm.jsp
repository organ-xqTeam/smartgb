...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ocruser/ocrUser/">租车用户列表</a></li>
		<li class="active"><a href="${ctx}/ocruser/ocrUser/form?id=${ocrUser.id}">租车用户<shiro:hasPermission name="ocruser:ocrUser:edit">${not empty ocrUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ocruser:ocrUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ocrUser" action="${ctx}/ocruser/ocrUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="jobNumber" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ocruser:ocrUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
